...
// Timers
#define TIMER6_DCU_uS                	10.0f		// Таймер тактирования ЦАП и АЦП для DCU
#define TIMER6_RCU_uS					4000		// Таймер защиты превышения синхросигнала для RCU
#define TIMER7_uS                  		1000		// Таймер общего назначения
#define TIMER2_3_uS						10000		// Таймеры для формирования управляющих импульсов
#define TIMER16_DCU_uS					5000		// Таймеры для формирования импульса синхронизации DCU
#define TIMER16_RCU_uS					4000		// Таймеры для формирования импульса синхронизации RCU
// ----------------------------------------------
