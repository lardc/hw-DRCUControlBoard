...
const TableItemConstraint NVConstraint[DATA_TABLE_NV_SIZE] = {
		{0, INT16U_MAX, INTPS_ADC_TO_V_OFFSET},													// 0
		{0, INT16U_MAX, INTPS_ADC_TO_V_K},														// 1
		{SW_PULSE_WIDTH_MIN, SW_PULSE_WIDTH_MAX, SW_PULSE_WIDTH_DEF},							// 2
		...
		{0, 0, 0},																				// 8
		{0, 0, 0},																				// 9
		{0, CTRL1_MAXIMUM_WIDTH_MAX, CTRL1_MAXIMUM_WIDTH_DEF},									// 10
		{0, CTRL2_MAXIMUM_WIDTH_MAX, CTRL2_MAXIMUM_WIDTH_DEF},									// 11
		{0, INT16U_MAX, CTRL1_OFFSET_DEF},														// 12
		{0, INT16U_MAX, CTRL1_K_DEF},															// 13
		{0, INT16U_MAX, CTRL2_OFFSET_DEF},														// 14
		{0, INT16U_MAX, CTRL2_K_DEF},															// 15
		{0, 0, 0},																				// 16
		{0, 0, 0},																				// 17
		{0, 0, 0},																				// 18
		{0, 0, 0},																				// 19
