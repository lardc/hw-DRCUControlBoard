...
#define ACT_DBG_PS_MECH_SWITCH_ON				21		// Включение силовых БП с помощью механического реле
#define ACT_DBG_PS_MECH_SWITCH_OFF				22		// Выключение силовых БП с помощью механического реле
#define ACT_DBG_FAN_ON							23		// Включение вентиляторов
#define ACT_DBG_FAN_OFF							24		// Выключение вентиляторов
#define ACT_DBG_PS_SSR_SWITCH_ON				25		// Включение силовых БП с помощью твердотельного размыкателя
#define ACT_DBG_PS_SSR_SWITCH_OFF				26		// Выключение силовых БП с помощью твердотельного размыкателя
//
