...
// 24
#define REG_CTRL1_MAX_WIDTH_050					25		// Максимальная длительность импульса CTRL1 при 0.5А/мкс
#define REG_CTRL1_MAX_WIDTH_075					26		// Максимальная длительность импульса CTRL1 при 0.75А/мкс
#define REG_CTRL1_MAX_WIDTH_100					27		// Максимальная длительность импульса CTRL1 при 1А/мкс
#define REG_CTRL1_MAX_WIDTH_250					28		// Максимальная длительность импульса CTRL1 при 2.5А/мкс
#define REG_CTRL1_MAX_WIDTH_500					29		// Максимальная длительность импульса CTRL1 при 5А/мкс
#define REG_CTRL1_MAX_WIDTH_750					30		// Максимальная длительность импульса CTRL1 при 7.5А/мкс
#define REG_CTRL1_MAX_WIDTH_1000				31		// Максимальная длительность импульса CTRL1 при 10А/мкс
#define REG_CTRL1_MAX_WIDTH_1500				32		// Максимальная длительность импульса CTRL1 при 15А/мкс
#define REG_CTRL1_MAX_WIDTH_2500				33		// Максимальная длительность импульса CTRL1 при 25А/мкс
#define REG_CTRL1_MAX_WIDTH_3000				34		// Максимальная длительность импульса CTRL1 при 30А/мкс
#define REG_CTRL1_MAX_WIDTH_5000				35		// Максимальная длительность импульса CTRL1 при 50А/мкс
#define REG_CTRL2_MAX_WIDTH						36		// Максимальная длительность импульса CTRL2
// 37 - 40
#define REG_I_TO_V_INTPS_050_OFFSET				41		// Смещение преобразования тока в напряжение внутреннего источника при 0.50 А/мкс
#define REG_I_TO_V_INTPS_050_K					42		// Коэффициент преобразования тока в напряжение внутреннего источника при 0.50 А/мкс
#define REG_I_TO_V_INTPS_075_OFFSET				43		// Смещение преобразования тока в напряжение внутреннего источника при 0.75 А/мкс
#define REG_I_TO_V_INTPS_075_K					44		// Коэффициент преобразования тока в напряжение внутреннего источника при 0.75 А/мкс
#define REG_I_TO_V_INTPS_100_OFFSET				45		// Смещение преобразования тока в напряжение внутреннего источника при 1.00 А/мкс
#define REG_I_TO_V_INTPS_100_K					46		// Коэффициент преобразования тока в напряжение внутреннего источника при 1.00 А/мкс
#define REG_I_TO_V_INTPS_250_OFFSET				47		// Смещение преобразования тока в напряжение внутреннего источника при 2.50 А/мкс
#define REG_I_TO_V_INTPS_250_K					48		// Коэффициент преобразования тока в напряжение внутреннего источника при 2.50 А/мкс
#define REG_I_TO_V_INTPS_500_OFFSET				49		// Смещение преобразования тока в напряжение внутреннего источника при 5.00 А/мкс
#define REG_I_TO_V_INTPS_500_K					50		// Коэффициент преобразования тока в напряжение внутреннего источника при 5.00 А/мкс
#define REG_I_TO_V_INTPS_750_OFFSET				51		// Смещение преобразования тока в напряжение внутреннего источника при 7.50 А/мкс
#define REG_I_TO_V_INTPS_750_K					52		// Коэффициент преобразования тока в напряжение внутреннего источника при 7.50 А/мкс
#define REG_I_TO_V_INTPS_1000_OFFSET			53		// Смещение преобразования тока в напряжение внутреннего источника при 10.0 А/мкс
#define REG_I_TO_V_INTPS_1000_K					54		// Коэффициент преобразования тока в напряжение внутреннего источника при 10.0 А/мкс
#define REG_I_TO_V_INTPS_1500_OFFSET			55		// Смещение преобразования тока в напряжение внутреннего источника при 15.0 А/мкс
#define REG_I_TO_V_INTPS_1500_K					56		// Коэффициент преобразования тока в напряжение внутреннего источника при 15.0 А/мкс
#define REG_I_TO_V_INTPS_2500_OFFSET			57		// Смещение преобразования тока в напряжение внутреннего источника при 25.0 А/мкс
#define REG_I_TO_V_INTPS_2500_K					58		// Коэффициент преобразования тока в напряжение внутреннего источника при 25.0 А/мкс
#define REG_I_TO_V_INTPS_3000_OFFSET			59		// Смещение преобразования тока в напряжение внутреннего источника при 30.0 А/мкс
#define REG_I_TO_V_INTPS_3000_K					60		// Коэффициент преобразования тока в напряжение внутреннего источника при 30.0 А/мкс
#define REG_I_TO_V_INTPS_5000_OFFSET			61		// Смещение преобразования тока в напряжение внутреннего источника при 50.0 А/мкс
#define REG_I_TO_V_INTPS_5000_K					62		// Коэффициент преобразования тока в напряжение внутреннего источника при 50.0 А/мкс
//
...
#define REG_CURRENT								202		// Измеренное значение амплитуды тока (в А)
// -----------------------------
