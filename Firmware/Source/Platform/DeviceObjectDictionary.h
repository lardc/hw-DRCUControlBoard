...
//
#define REG_CTRL1_050_OFFSET					63		// Смещение грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL1_050_K							64		// Коэффициент грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL1_075_OFFSET					65		// Смещение грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL1_075_K							66		// Коэффициент грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL1_100_OFFSET					67		// Смещение грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL1_100_K							68		// Коэффициент грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL1_250_OFFSET					69		// Смещение грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL1_250_K							70		// Коэффициент грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL1_500_OFFSET					71		// Смещение грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL1_500_K							72		// Коэффициент грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL1_750_OFFSET					73		// Смещение грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL1_750_K							74		// Коэффициент грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL1_1000_OFFSET					75		// Смещение грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL1_1000_K						76		// Коэффициент грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL1_1500_OFFSET					77		// Смещение грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL1_1500_K						78		// Коэффициент грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL1_2500_OFFSET					79		// Смещение грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL1_2500_K						80		// Коэффициент грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL1_3000_OFFSET					81		// Смещение грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL1_3000_K						82		// Коэффициент грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL1_5000_OFFSET					83		// Смещение грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL1_5000_K						84		// Коэффициент грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL2_OFFSET						85		// Смещение грубой подстройки тока при скрости спада 0.5 А/мкс
#define REG_CTRL2_K								86		// Коэффициент грубой подстройки тока при скрости спада 0.5 А/мкс
//
