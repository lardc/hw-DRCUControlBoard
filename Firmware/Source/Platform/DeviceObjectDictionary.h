...
#define REG_SW_PULSE_WIDTH						9		// Длительность импульса в режиме программного запуска, мкс
...
#define REG_CONFIG_RDY_STATE_TIMEOUT			13		// Таймаут нахождения блока в состоянии ConfigReady
//
#define REG_CTRL1_MAX_WIDTH						20		// Максимальная длительность импульса CTRL1 при 50А/мкс
#define REG_CTRL2_MAX_WIDTH						21		// Максимальная длительность импульса CTRL2
//
#define REG_CTRL1_OFFSET						22		// Смещение грубой подстройки тока при скрости спада 50.0 А/мкс
#define REG_CTRL1_K								23		// Коэффициент грубой подстройки тока при скрости спада 50.0 А/мкс
#define REG_CTRL2_OFFSET						24		// Смещение грубой подстройки тока
#define REG_CTRL2_K								25		// Коэффициент грубой подстройки тока
//
